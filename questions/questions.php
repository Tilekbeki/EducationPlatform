                ...
                <div class="questions__item-wrap">
                    ...
                    <?php foreach ($sections as $section) {?>
                        <div class="questions__section">
                            <?php if($section['id_question']==$question['id']) {?>
                                <div class="questions__section-item">
                                    ...
                                    ?>
                                    <img src="data:image/png;base64, <?php echo base64_encode($section['title']);; ?>" alt="title" class="questions__question-img">
                                    </div>
                                    <?php
                                        if($section['title']) { ?>
                                        ...
                                        <div class="container">
                                                <div class="questions__modal-content">
                                                    <div class="questions__modal-wrapp">
                                                        ...
                                                        <div class="questions__modal-answer"><h4><?php echo $section['name']; ?></h4><img src="data:image/png;base64, <?php echo base64_encode($section['answerImg']);; ?>" alt="question" class="questions__subquestion"></div>
                                                    </div>
