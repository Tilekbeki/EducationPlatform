                                ...
                                if(Isset($_GET['do']) && $_GET['do'] == 'topics' && !Isset($_GET['subject']) && !Isset($_GET['course'])) {
                                    ...
                                    <div class="select__title-course"><?php echo "Courses:" ?></div>
                                        ...
                                        <?php
                                                ...
                                                <li><a href="?do=courses">there`s nothinggg, but you can create</a></li>
                                            <?php }?>
                                    ...
                                    foreach ($courses as $course) {?> 
                                        ...
                                        <?php $topicTitle=''; foreach ($topics as $topic) {
                                           ...
                                           <?php }
                                            ...
                                            <li><a href="?do=topics&course=<?php echo $course['name']; ?>&subject=<?php echo $subject['name']; ?>">there`s nothinggg, but you can create</a></li>
                                        <?php }?>
                                        </ul><?php
                                    }  ?>
                            ...
                            <?php if (!empty($_GET['update_question'])) { ?>
                                ...
                                <?php foreach ($questions as $question) {
                                 if ($question['id'] == $_GET['update_question']) { ?>
                                    ...
                                    <p>Question image<input type="file" name = "QuestionImgg"></p>
                                       ...
                                       if ($subtopic['topic'] == $topic['name']) { ?>
                                           ...
                                           <ul class="select__list-question"> 
                                               ...
                                               $questionTitle = '';
                                                   ...
                                                   if (!$questionTitle) { ?>
                                                       <li><a href="?do=questions&subtopic=<?php echo $subtopic['name']; ?>">there`sssss nothing, but you can create</a></li>
                                                   <?php }
                                               ?>
                                      </ul> <?php } 
                                   } if (!$subtopicTitle){ ?>
                                       <li><a href="?do=subtopics&topic=<?php echo $topic['name']; ?>">there`s nothing, but you can create</a></li>
                                   <?php }
                               ?>
                           </ul>
                      <?php }
...
<?php
                                    foreach($selections as $section) {
                                        if($section['name'] == 'b' && $section['id_question']) { ?>
                                                ...
                                                <?php if ($_SESSION['count']==9) {
                                                    ...
                                                    <?php $i++; } ?>
                                                    <small style="color: red;">Only the filled-in fields will change!</small>
                                                    <p>Question</p>
                                                    <select required type="text" name="SelectedQuestionId" id="SelectedQuestionId">
                                                                <?php foreach ($questions as $question) { 
                                                                    if($question['id']==$_GET['update_section']){ ?>
                                    ...
                                    <?php if(isset($_GET['do']) && $_GET['do']  == 'sections' && !Isset($_GET['questionTitle'])) {
                                            ...
                                            <table>
                                                <tr><th>Section</th><th>Question</th><th>Update</th></tr> 
                                            <?php foreach ($selections as $selection) { 
                                                if($selection['name'] == 'a') {?> 
                                                <tr>
                                                    <td><?php echo "10 sections" ?></td>
